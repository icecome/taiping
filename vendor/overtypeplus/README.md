...
A lightweight markdown editor library with perfect WYSIWYG alignment using an invisible textarea overlay technique. Includes optional toolbar. ~185KB minified with all features.
...
|---------|----------|---------|----------|------------|---------|
| **Size** | ~185KB | 364.02 KB | 344.51 KB | 560.99 KB | 323.69 KB |
